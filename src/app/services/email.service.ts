    ...
    const html = `
      ...
      <head>
        ...
        <style>
          ...
          .reservation-card { background: #f8f9fa; border-radius: 10px; padding: 20px; margin: 20px 0; border-left: 4px solid #48bb78; }
          ...
          .reservation-title { font-size: 20px; color: #2c3e50; font-weight: bold; margin-bottom: 15px; }
          .reservation-detail { display: flex; padding: 10px 0; border-bottom: 1px solid #e0e0e0; }
          .reservation-detail:last-child { border-bottom: none; }
          .detail-label { flex: 0 0 140px; font-weight: 600; color: #666; }
          .detail-value { flex: 1; color: #2c3e50; }
          .total-section { background: #48bb78; color: white; padding: 15px 20px; border-radius: 8px; margin: 20px 0; display: flex; justify-content: space-between; align-items: center; }
          .total-amount { font-size: 28px; font-weight: bold; }
          .next-steps { background: #e3f2fd; border-radius: 10px; padding: 20px; margin: 20px 0; }
          .next-steps h3 { color: #1565c0; margin-top: 0; }
          .next-steps ul { margin: 10px 0; padding-left: 25px; }
          .next-steps li { margin: 8px 0; color: #2c3e50; }
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="reservation-card">
              <img src="${imageUrl}" alt="${experienceTitle}" class="experience-img">
